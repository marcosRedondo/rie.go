...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["riego-modules-summary-summary-module"], {
  ...
  /***/
  function srcAppModulesSummaryComponentsMeasureCardMeasureCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MeasureCardComponent", function () {
      return MeasureCardComponent;
    });
    /* harmony import */
    ...
    function MeasureCardComponent_i_7_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i", 9);
      }
    }

    function MeasureCardComponent_i_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i", 10);
      }
    }

    function MeasureCardComponent_i_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i", 11);
      }
    }

    function MeasureCardComponent_i_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "i", 12);
      }
    }

    var MeasureCardComponent = /*#__PURE__*/function () {
      function MeasureCardComponent() {
        _classCallCheck(this, MeasureCardComponent);
      }

      _createClass(MeasureCardComponent, [{
        key: "ngOnInit",
    ...
    MeasureCardComponent.ɵfac = function MeasureCardComponent_Factory(t) {
      return new (t || MeasureCardComponent)();
    };

    MeasureCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MeasureCardComponent,
      selectors: [["measure-card"]],
      inputs: {
        measure: "measure"
      },
      decls: 12,
      vars: 7,
      consts: [[1, "card", "bg-primary", "text-white"], [1, "card-header"], [1, "card-body"], [1, "card-title"], [1, "card-text", "fs-5rem"], ["class", "fa fa-tint", "aria-hidden", "true", 4, "ngIf"], ["class", "fa fa-thermometer-full", "aria-hidden", "true", 4, "ngIf"], ["class", "fa fa-leaf", "aria-hidden", "true", 4, "ngIf"], ["class", "fa fa-sun-o", "aria-hidden", "true", 4, "ngIf"], ["aria-hidden", "true", 1, "fa", "fa-tint"], ["aria-hidden", "true", 1, "fa", "fa-thermometer-full"], ["aria-hidden", "true", 1, "fa", "fa-leaf"], ["aria-hidden", "true", 1, "fa", "fa-sun-o"]],
      template: function MeasureCardComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MeasureCardComponent, [{
  ...
  /***/
  function srcAppModulesSummaryPagesSummarySummaryPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _components_measure_card_measure_card_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../components/measure-card/measure-card.component */
    "./src/app/modules/summary/components/measure-card/measure-card.component.ts");

    function SummaryPage_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SummaryPage = /*#__PURE__*/function () {
      function SummaryPage(measureService) {
      ...
      _createClass(SummaryPage, [{
        ...
        key: "getLastMeasures",
        value: function getLastMeasures() {
          this.measures.push({
            type: "temperature",
            title: "Temperatura Ambiente",
            date: "18/04/2020 14:05",
            value: "35ºC"
          }, {
            type: "humidity",
    ...
    SummaryPage.ɵfac = function SummaryPage_Factory(t) {
      return new (t || SummaryPage)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_riego_shared_services_measure_service__WEBPACK_IMPORTED_MODULE_1__["MeasureService"]));
    };

    SummaryPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SummaryPage,
      selectors: [["app-summary"]],
      decls: 3,
      vars: 1,
      consts: [[1, "container-fluid"], [1, "row"], ["class", "col-6 text-center mb-3", 4, "ngFor", "ngForOf"], [1, "col-6", "text-center", "mb-3"], [3, "measure"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _components_measure_card_measure_card_component__WEBPACK_IMPORTED_MODULE_3__["MeasureCardComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SummaryPage, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModulesSummarySummaryRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _pages_summary_summary_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./pages/summary/summary.page */
    "./src/app/modules/summary/pages/summary/summary.page.ts");

    var routes = [{
      path: "",
      component: _pages_summary_summary_page__WEBPACK_IMPORTED_MODULE_2__["SummaryPage"]
    }];
  ...
  /***/
  function srcAppModulesSummarySummaryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _summary_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./summary-routing.module */
    "./src/app/modules/summary/summary-routing.module.ts");
    /* harmony import */


    var _pages_summary_summary_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./pages/summary/summary.page */
    "./src/app/modules/summary/pages/summary/summary.page.ts");
    /* harmony import */


    var _components_measure_card_measure_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/measure-card/measure-card.component */
    "./src/app/modules/summary/components/measure-card/measure-card.component.ts");
    ...
    SummaryModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _summary_routing_module__WEBPACK_IMPORTED_MODULE_2__["SummaryRoutingModule"]]]
    });
...
//# sourceMappingURL=riego-modules-summary-summary-module-es5.js.map